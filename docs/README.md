# Kawika documentation

Start with **About** if you are new to the project, then **Setup** to run it.

| Document | What it covers |
| -------- | -------------- |
| [About](about.md) | The problem, mission, principles, audience, and roadmap |
| [Setup](setup.md) | Installing and running the client, API, and PostgreSQL locally |
| [Architecture](architecture.md) | How the pieces fit, request flow, and folder conventions |
